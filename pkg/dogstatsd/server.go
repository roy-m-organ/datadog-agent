...
var (
	...
	tlmProcessedError = tlmProcessed.WithTags(map[string]string{"message_type": "metrics", "state": "error", "origin": ""})
	tlmProcessedOk    = tlmProcessed.WithTags(map[string]string{"message_type": "metrics", "state": "ok", "origin": ""})
